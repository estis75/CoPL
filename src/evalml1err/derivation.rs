...
impl EvalML1Err {
  ...
  pub fn get_tree_eint(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::EInt)).captures_iter(&self.obj).next() {
      ...
      if i1.is_ok() {
        ...
        if i2.is_ok() {
          ...
          if i1 == i2 {
            v = Some(RuleTree{
              obj: Object::EvalML1Err(Rule::EInt),
  ...
  pub fn get_tree_ebool(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::EBool)).captures_iter(&self.obj).next() {
      ...
      if i1.is_ok() {
        ...
        if i2.is_ok(){
          ...
          if i1 == i2 {
            v = Some(RuleTree{
              obj: Object::EvalML1Err(Rule::EBool),
              val: format!("{} evalto {}", i1, i2),
              node: None
            });
            state = true;
  ...
  pub fn get_tree_eift(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::EIfT)).captures_iter(&self.obj).next() {
      ...
      if let Some(c) = c {
        tp.push(c);
        if self.is_value(cap[4].to_string()) {
          ...
          if let Some(c) = c {
            ...
            v = Some(RuleTree{
              obj: Object::EvalML1Err(Rule::EIfT),
  ...
  pub fn get_tree_eiff(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::EIfF)).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
      ...
      if let Some(c) = c {
        ...
        if self.is_value(cap[4].to_string()) {
          ...
          if let Some(c) = c {
            ...
            v = Some(RuleTree{
              obj: Object::EvalML1Err(Rule::EIfF),
  ...
  pub fn get_tree_eplus(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::EPlus)).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
            ...
            if let Some(rhs) = Regex::new(r".* evalto (.*)").unwrap().captures_iter(&rhs.val).next() {
              ...
              if lhs.is_ok() && rhs.is_ok() {
                ...
                let val = if cap[3].to_string() == String::from("?") {
                  ...
                  let ret = self.parse_int(cap[3].to_string());
                  if ret.is_ok() {
                    Ok(ret.ok().unwrap())
                  }else{
                    Err(())
                ...
                if val.is_ok() && lhs + rhs == val.ok().unwrap() {
                  ...
                  let c = EvalML1Err{obj: tpval}.solver();
                  if let Some(c) = c {
                    tp.push(c);

                    v = Some(RuleTree{
                      obj: Object::EvalML1Err(Rule::EPlus),
  ...
  pub fn get_tree_eminus(&self) -> (Option<RuleTree>, bool) {
    ...
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::EMinus)).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);

      let val = format!("{} evalto ?", self.unwrap_if_parened(cap[1].to_string()));
      let c = EvalML1Err{obj: val.clone()}.solver();
      if let Some(lhs) = c {
        tp.push(lhs.clone());
        if let Some(lhs) = Regex::new(r".* evalto (.*)").unwrap().captures_iter(&lhs.val).next() {
          let val = format!("{} evalto ?", self.unwrap_if_parened(cap[2].to_string()));
              ...
              if lhs.is_ok() && rhs.is_ok() {
                ...
                if lhs - rhs == val {
                  ...
                  if let Some(c) = c {
                    ...
                    v = Some(RuleTree{
                      obj: Object::EvalML1Err(Rule::EMinus),
                      val: format!("{} - {} evalto {}", &cap[1], &cap[2], val),
                      node: Some(tp)
                    });
                    state = true;
  ...
  pub fn get_tree_etimes(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::ETimes)).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
              ...
              if lhs.is_ok() && rhs.is_ok() {
                ...
                if lhs * rhs == val {
                  ...
                  if let Some(c) = c {
                    ...
                    v = Some(RuleTree{
                      obj: Object::EvalML1Err(Rule::ETimes),
                      val: format!("{} * {} evalto {}", &cap[1], &cap[2], val),
                      node: Some(tp)
                    });
                    state = true;
  ...
  pub fn get_tree_elt(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::ELt)).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
              ...
              if lhs.is_ok() && rhs.is_ok() {
                ...
                if (lhs < rhs) == val {
                  ...
                  if let Some(c) = c {
                    ...
                    v = Some(RuleTree{
                      obj: Object::EvalML1Err(Rule::ELt),
                      val: format!("{} < {} evalto {}", &cap[1], &cap[2], val),
                      node: Some(tp)
                    });
                    state = true;
  ...
  pub fn get_tree_bplus(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::BPlus)).captures_iter(&self.obj).next() {
      let i1 = self.parse_int(cap[1].to_string());
      ...
      if i1.is_ok() && i2.is_ok() {
        ...
        if i3.is_ok(){
          ...
          if i1 + i2 == i3 {
            v = Some(RuleTree{
              obj: Object::EvalML1Err(Rule::BPlus),
  ...
  pub fn get_tree_bminus(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::BMinus)).captures_iter(&self.obj).next() {
      let i1 = self.parse_int(cap[1].to_string());
      let i2 = self.parse_int(cap[2].to_string());
      let i3 = cap[3].to_string();
      if i1.is_ok() && i2.is_ok() {
        ...
        if i3.is_ok(){
          ...
          if i1 - i2 == i3 {
            v = Some(RuleTree{
              obj: Object::EvalML1Err(Rule::BMinus),
  ...
  pub fn get_tree_btimes(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::BTimes)).captures_iter(&self.obj).next() {
      let i1 = self.parse_int(cap[1].to_string());
      let i2 = self.parse_int(cap[2].to_string());
      let i3 = cap[3].to_string();
      if i1.is_ok() && i2.is_ok() {
        ...
        if i3.is_ok(){
          ...
          if i1 * i2 == i3 {
            v = Some(RuleTree{
              obj: Object::EvalML1Err(Rule::BTimes),
  ...
  pub fn get_tree_blt(&self) -> (Option<RuleTree>, bool) {
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(Object::EvalML1Err(Rule::BLt)).captures_iter(&self.obj).next() {
      let i1 = self.parse_int(cap[1].to_string());
      let i2 = self.parse_int(cap[2].to_string());
      let i3 = cap[3].to_string();
      if i1.is_ok() && i2.is_ok() {
        ...
        if i3.is_ok() {
          ...
          if (i1 < i2) == i3 {
            v = Some(RuleTree{
              obj: Object::EvalML1Err(Rule::BLt),
