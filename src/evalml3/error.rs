...
impl EvalML3 {
  ...
  pub fn get_tree_eplusbooll(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EPlusBoolL);
    let mut v = None;
    let mut state = false;
  ...
  pub fn get_tree_eplusboolr(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EPlusBoolR);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_epluserrorl(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EPlusErrorL);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_epluserrorr(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EPlusErrorR);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eminusbooll(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EMinusBoolL);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eminusboolr(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EMinusBoolR);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eminuserrorl(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EMinusErrorL);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eminuserrorr(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EMinusErrorR);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_etimesbooll(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::ETimesBoolL);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_etimesboolr(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::ETimesBoolR);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_etimeserrorl(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::ETimesErrorL);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_etimeserrorr(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::ETimesErrorR);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eltbooll(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::ELtBoolL);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eltboolr(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::ELtBoolR);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_elterrorl(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::ELtErrorL);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_elterrorr(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::ELtErrorR);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eifint(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EIfInt);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eiferror(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EIfError);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eifterror(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EIfTError);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
  ...
  pub fn get_tree_eifferror(&self) -> (Option<RuleTree>, bool) {
    const OBJ: Object = Object::EvalML3(Rule::EIfFError);
    let mut v = None;
    let mut state = false;
    if let Some(cap) = self.get_regex(OBJ).captures_iter(&self.obj).next() {
      let mut tp = Vec::with_capacity(3);
